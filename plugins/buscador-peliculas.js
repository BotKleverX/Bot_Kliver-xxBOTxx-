/* Creado/adaptado por Mahmoudᴷᴸᴱᵛᴱᴿ (https://github.com/BotKleverX) */

import fetch from 'node-fetch'
import axios from 'axios'
import { load } from 'cheerio'
let handler = async (m, {text, usedPrefix, command, conn}) => {
if (!text) throw '*[❗] أدخل اسم فيلم للبحث عنه*'   
let aaaa
let img
try {   
...
if (aaaa == '') throw '*[❗] لم يتم العثور على الفيلم*' 
...
handler.command = ['cuevana', 'pelisplus', 'فيلم', 'film',]
...
/* creado adaptado por Mahmoudᴷᴸᴱᵛᴱᴿ*/
/* arreglado por skid */
